%% Q2x Normal and Laplacian Blend 
%% Please Also refer to qx_2_classic.m for the classic hybrid apple/orange blend

or=double(imread('oranges.jpg'));
al=double(imread('alex.jpg'));
mk=double(imread('mask.jpg'));
